...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hpbm9iaXgxMjM0NTYiLCJhIjoiY2xrczlkcXppMDFocTNxcG5wZDhmeDFqbSJ9.Xrr92F68KrlUcfhoNGx7pQ';
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateSetthings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateSetthings = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var updateSetthings = /*#__PURE__*/function () {
  ...
  return function updateSetthings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.updateSetthings = updateSetthings;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NbC0CDuf7GSaJ7iaxroslib7UNqobMcjWbVebJe3lvcZwVJ1A9vAxtif76QM7EZ4D4VllZADEr4qF25t4ZjAQiz00aG69IDFY');
...
var _updateSetthings = require("./updateSetthings.js");
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSetthings.updateSetthings)(form, 'data');
  });
}
if (userPasswordForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSetthings.updateSetthings)({
